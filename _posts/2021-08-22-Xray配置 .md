...
将密钥文件存入相应文件中 fullchainpath（公钥文件.crt)  keypath（密钥文件.key)
    ...
    "inbounds": [
        {
            ...
            "streamSettings": {
                ...
                "security": "xtls", 
                "xtlsSettings": {
                    "serverName": "bg.vegvegveg.ml",  //你的域名
                    "alpn": [
                        "h2", 
                        "http/1.1"
                    ], 
                    "certificates": [
                        {
                            "certificateFile": "/usr/local/etc/ssl/private/bg.vegvegveg.ml.crt",
                            "keyFile": "/usr/local/etc/ssl/private/bg.vegvegveg.ml.key" //前面的证书路径
                        }
                    ]
                }
            }
...
![Untitled](Xray%E9%85%8D%E7%BD%AE%2096e75de997bf45e79d4917ec7e470d5e/Untitled.png) -->